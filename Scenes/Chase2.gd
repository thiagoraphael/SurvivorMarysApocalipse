...
var texture_chase = preload("res://Assets/SPRITES/mary.png")
var texture_default = preload("res://Assets/SPRITES/mary.png")
...
func physics_update(delta: float):
	...
	(owner as MyZombie).move_to_position(next_position)
...
func try_to_stop_chasing() -> bool:
	...
	var distance_to_player = (owner as MyZombie).global_position.distance_to(player_position)
